...
const FlowDesigner = () => {
  ...
  // Update existing nodes to include delete function
  useEffect(() => {
    setNodes((nds) =>
      nds.map((node) => ({
        ...node,
  ...
  }, [handleNodeUpdate, handleNodePlay, handleNodeTest, handleNodeDelete]);
          ...
          >
            ...
            {showMinimap && (
              <MiniMap 
                ...
                nodeColor={(node) => {
                  switch (node.type) {
                    case 'sayNode': return '#10b981';
                    case 'collectNode': return '#3b82f6';
